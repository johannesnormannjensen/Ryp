    ...
    <div class="panel panel-default">
        ...
        <form:form method="POST" modelAttribute="reviewForm" class="form-horizontal">
            ...
            <div class="input-group input-sm">
                ...
                <form:textarea type="text" class="form-control" id="body" name="body" path="body"
                            placeholder="Review text"/>
            </div>

            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>

            <form:input type="hidden" id="source_user_id" name="source_user_id" path="source_user_id"
                        value="${reviewForm.source_user_id}"/>
            <form:input type="hidden" id="target_user_id" name="target_user_id" path="target_user_id"
                        value="${reviewForm.target_user_id}"/>
            <form:input type="hidden" id="game_id" name="game_id" path="game_id" value="${reviewForm.game_id}"/>

            <div class=" input-group input-sm">
                <input type="submit" value="Add review" class="btn btn-block btn-success btn-default"/>
            </div>
        </form:form>
